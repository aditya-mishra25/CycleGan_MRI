### importing tensorflow and matplotlib to create a train step and print the out put for every epoch
### epoch and other details are set from the main file
### every epoch's output is stored in directory - Epoch-Outputs
...
class CycleGAN:
    ...
    def build_discriminator(self, image_shape):
        raise Exception("Not implemented")
    ### train function to put all the other functions together defined above to run CycleGan
    def train(self, data_x, data_y, epochs: int, save_ckpt: bool = True, plot_results: bool = False, save_results:bool=False,
        ...
        for epoch in range(1, epochs + 1):
            ...
            if plot_results:
                ...
                plt.savefig('/home/Capstone/Epoch-Outputs/image_at_epoch_{:04d}.png'.format(epoch))
